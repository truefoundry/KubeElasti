...
Set `.global.enableMonitoring` to `true` in the [values.yaml](https://github.com/KubeElasti/KubeElasti/blob/main/charts/elasti/values.yaml) file to enable monitoring.
